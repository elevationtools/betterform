...
#### Interface (although internal only) ####

# No defaults because we never expect this to be called directly.
...
$(STAGE_OUTPUT_DIR)/.terraform.lock.hcl: \
...
$(STAGE_OUTPUT_DIR) $(STAGE_GENFILES):
	mkdir -p $@
